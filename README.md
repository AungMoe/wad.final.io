...
This project was bootstrapped with [Create React App](https://github.com/facebook/create-react-app). By using [Firebase](https://firebase.google.com/) by google, the data inputed here are stored in the database.
